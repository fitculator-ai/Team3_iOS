...
public struct WorkoutRequest: Codable {
    ...
    // ✅ 직접 초기화 생성자 추가
    public init(userId: Int, exerciseType: String, exerciseKorName: String, exerciseEngName: String, recordDate: String, recordStart: String, duration: Int, avgHeartRate: Int, highHeartRate: Int, memo: String? = nil) {
        self.userId = userId
        self.exerciseType = exerciseType
        self.exerciseKorName = exerciseKorName
        self.exerciseEngName = exerciseEngName
...
public struct WorkoutRequestResponse: Codable {
    let success: Bool
    let message: String
